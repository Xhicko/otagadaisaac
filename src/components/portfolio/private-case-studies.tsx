...
import { privateCaseStudies } from "@/data/portfolio";

export function PrivateCaseStudies() {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-[#0F172A] sm:text-4xl">
            Internal systems shown without sensitive exposure
          </h2>
          <p className="mt-6 w-full text-base leading-7 text-[#334155] sm:text-lg">
            These projects are presented as case studies only. Private admin
            links, credentials, user data, payment data, and sensitive records
            are not exposed.
          </p>
        </div>
        ...
        <ol className="mx-auto mt-12 max-w-6xl">
          {privateCaseStudies.map((project, index) => {
            const isFadedPreview = index === 1;
            const isHiddenUntilExpanded = index > 1;
                ...
                <article className="overflow-hidden">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 top-1 md:relative md:left-auto md:top-auto">
                      ...
                      {index < privateCaseStudies.length - 1 ? (
                      ...
                      >
                        <div className="overflow-hidden">
                          {project.availability ? (
                            <p className="mt-4 max-w-3xl rounded-lg border border-[#0F172A]/15 bg-white/35 p-4 text-sm font-semibold leading-6 text-[#334155]">
                              {project.availability}
                            </p>
                          ) : null}
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            />
            <span>{showAll ? "Less, Please" : "More Case Studies"}</span>
          </button>
        </div>
      </div>
    </section>
