      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight text-[#0F172A] sm:text-4xl">
            Tools used across web app delivery
          </h2>
          <p className="mt-6 w-full text-base leading-7 text-[#334155] sm:text-lg">
            Grouped by the work clients usually need: interfaces, backends,
            databases, auth, payments, email, DNS, deployment, AI systems, and
            documentation.
          </p>
        </div>
                            ...
                            {group.items.map((item) => (
                              <span
                                className={`rounded-full border px-3 py-1 text-xs font-medium transition-colors duration-300 ${
                                  shouldFade
                                    ? "border-[#64748B]/20 bg-white/25 text-[#64748B]"
                                    : "border-[#0F172A]/15 bg-white/45 text-[#334155]"
                                }`}
                                key={item}
                              >
                                {item}
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            />
            <span>{showAll ? "Less, Please" : "More Tech Stack"}</span>
          </button>
        </div>
      </div>
    </section>
